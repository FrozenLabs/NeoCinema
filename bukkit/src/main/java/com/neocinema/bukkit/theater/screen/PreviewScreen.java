package com.neocinema.bukkit.theater.screen;
...
public class PreviewScreen implements PacketByteBufSerializable<PreviewScreen> {
    ...
    public PreviewScreen(String world, int x, int y, int z, String facing) {
        ...
        this.z = z;
        this.facing = facing;
        staticTextureUrl = "https://cinemamodstatic.ewr1.vultrobjects.com/images/flatscreen_bars.jpg";
        activeTextureUrl = "https://cinemamodstatic.ewr1.vultrobjects.com/images/flatscreen_bg1.jpg";
    }
