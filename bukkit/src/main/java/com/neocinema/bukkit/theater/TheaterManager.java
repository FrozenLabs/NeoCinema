...
public class TheaterManager {
    ...
    private NeoCinemaPlugin neoCinemaPlugin;
    private List<Theater> theaters;

    public TheaterManager(NeoCinemaPlugin neoCinemaPlugin) {
    ...
    public synchronized void loadFromConfig(ConfigurationSection theaterSection) {
        ...
        for (String theaterId : theaterSection.getKeys(false)) {
            ...
            switch (theaterType) {
                case "public":
                    theater = new PublicTheater(neoCinemaPlugin, theaterId, theaterName, theaterHidden, screen);
                    break;
                case "private":
                    theater = new PrivateTheater(neoCinemaPlugin, theaterId, theaterName, theaterHidden, screen);
                    break;
                case "static":
                    ...
                    theater = new StaticTheater(neoCinemaPlugin, theaterId, theaterName, theaterHidden, screen, staticUrl, staticResWidth, staticResHeight);
                    break;
                default:
