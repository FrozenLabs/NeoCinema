...
public abstract class VideoListWidgetEntry extends ElementListWidget.Entry<VideoListWidgetEntry> implements Comparable<VideoListWidgetEntry> {
    ...
    private static final Identifier PLAY_TEXTURE = Identifier.of(NeoCinema.MODID, "textures/gui/play.png");
    private static final Identifier PLAY_SELECTED_TEXTURE = Identifier.of(NeoCinema.MODID, "textures/gui/play_selected.png");
    ...
    public void render(DrawContext context, int index, int y, int x, int entryWidth, int entryHeight, int mouseX, int mouseY, boolean hovered, float tickDelta) {
        if (video.getVideoInfo() == null) {
            this.parent.videoList.remove(video.getVideoInfo());
            this.parent.update();
